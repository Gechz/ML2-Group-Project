...
def chat_with_model(user_id, user_message, fridge_image, fridge_description):
    ...
    personalized_message = (f"User name: {user_preferences['name']}, Household size: {user_preferences['household_size']}, "
                            ...
                            f"Focus only on ingredients like rice, milk, eggs, and items like toilet paper. Be specific with products such as grapes instead of simply saying fruits. I want high level of product suggestion. "
                            ...
                            f"If you are forced in using objects such as / to present 1/2 lbs, use instead 0.5, so there are no issues."
...
st.markdown("This is an optional feature in which when a picture is included, a brief description is required to proceed with the conversation. This will help identify what you have presented within the image so it can give a more thorough recommendation!")
image = None
